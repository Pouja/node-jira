...
var url = require('url'),
    debug = require('debug')('node-jira'),
    debugError = require('debug')('node-jira:error')
    OAuth = require("oauth");
...
var JiraApi = exports.JiraApi = function(protocol, host, port, username, password, apiVersion, verbose, strictSSL, oauth) {
    ...
    this.doRequest = function(options, callback) {
        ...
        debug('Making request ' + options.uri)
...
(function() {
    ...
    this.findIssue = function(issueNumber, callback) {
        ...
        this.doRequest(options, function(error, response, body) {
            ...
            if (error) {
                callback(error, null);
							debugError('Failed making request, request returned with body: ' + body);
    ...
    // ## Direct url request##
    // Usefull when another api call contains an api url.
    // ### Takes ###
    //
    // *  ref: The url to be retrieved.
    // *  callback: for when it's done
    //
    // ### Returns ###
    //
    // *  error: string with the error
    // *  results: the object has returned by the request
    /**
     ...
     * @param callback
     */
    this.requestRef = function(ref, callback) {
        var options = {
            rejectUnauthorized: this.strictSSL,
            uri: ref,
            method: 'GET',
        ...
        this.doRequest(options, function(error, response, body) {
            ...
            if (error) {
                callback(error, null);
                debugError('Error retrieving data for ' + ref + '. The request returned with the body: ' + body);
                return;
            }
            ...
            callback(response.statusCode + ': Error while getting.. Body of response is: ' + body + '.');
    ...
    //
    // *  error: string with the error
    // *  results: List of favourites of the current user.
    /**
     * Returns all the favourites for the current user.
     *
     * @param callback
     */
    this.getFavourites = function(callback) {
        ...
        this.doRequest(options, function(error, response, body) {
            ...
            if (error) {
                callback(error, null);
                debugError('Error retrieving all the favourites. The request returned with the body: ' + body);
                return;
            }
            ...
            callback(response.statusCode + ': Error while getting the favourites.');
    ...
    this.issueLink = function(link, callback) {
        ...
        this.doRequest(options, function(error, response) {
            ...
            if (error) {
                callback(error, null);
							debugError('Failed making request, request returned with body: ' + repsonse.body);
                return;
            }
    ...
    this.listComponents = function(project, callback) {
        ...
        this.doRequest(options, function(error, response, body) {
            ...
            callback(response.statusCode + ': Error while updating. Body of response is: ' + body + '.');
    ...
    this.transitionIssue = function(issueNum, issueTransition, callback) {
        ...
        this.doRequest(options, function(error, response) {
            ...
            callback(response.statusCode + ': Error while updating. Body of response is: ' + repsonse.body + '.');
    ...
    this.addComment = function(issueId, comment, callback){
        ...
        this.doRequest(options, function(error, response, body) {
            ...
            callback(response.statusCode + ': Error while adding comment. Body of response is: ' + body + '.');
        });
    };
    ...
    this.listIssueTypes = function(callback) {
        ...
        this.doRequest(options, function(error, response, body) {
            ...
            callback(response.statusCode + ': Error while retrieving issue types. Body of response is: ' + body + '.');
    ...
    this.registerWebhook = function(webhook, callback) {
        ...
        this.request(options, function(error, response, body) {
            ...
            callback(response.statusCode + ': Error while registering new webhook. Body of response is: ' + body + '.');
    ...
    this.listWebhooks = function(callback) {
        ...
        this.request(options, function(error, response, body) {
            ...
            callback(response.statusCode + ': Error while listing webhooks. Body of response is: ' + body + '.');
    ...
    this.getWebhook = function(webhookID, callback) {
        ...
        this.request(options, function(error, response, body) {
            ...
            callback(response.statusCode + ': Error while getting webhook. Body of response is: ' + body + '.');
    ...
    this.deleteWebhook = function(webhookID, callback) {
        ...
        this.request(options, function(error, response, body) {
            ...
            callback(response.statusCode + ': Error while deleting webhook. Body of response is: ' + body + '.');
    ...
    this.getCurrentUser = function(callback) {
        ...
        this.doRequest(options, function(error, response, body) {
            ...
            callback(response.statusCode + ': Error while getting current user. Body of response is: ' + body + '.');
    ...
    this.getBacklogForRapidView = function(rapidViewId, callback) {
        ...
        this.doRequest(options, function(error, response) {
            ...
            callback(response.statusCode + ': Error while retrieving backlog. Body of response is: ' + repsonse.body + '.');
        });
    };
